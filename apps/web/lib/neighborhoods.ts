...
export const CORE_AREAS: Area[] = [
  { note: "Fulton Cleaners is on Fulton Street in Clinton Hill, so this is the shortest trip we make — the bag rarely leaves the neighborhood.", name: 'Clinton Hill', miles: 0 },
  { note: "A few blocks down Vanderbilt. One of the closest neighborhoods we collect from.", name: 'Prospect Heights', miles: 0.2 },
  { note: "Across the park from the shop. Most Fort Greene pickups are a five-minute drive each way.", name: 'Fort Greene', miles: 0.4 },
  { note: "Straight out Fulton Street. Bed-Stuy is one of the largest areas inside our band and every part of the western half is comfortably in it.", name: 'Bedford-Stuyvesant', miles: 0.5 },
  { note: "Half a mile past the park. All of Park Slope sits inside the three-mile band.", name: 'Park Slope', miles: 0.5 },
  { note: "Under a mile from the shop, so a Downtown Brooklyn bag is usually the fastest round trip on the board.", name: 'Downtown Brooklyn', miles: 0.7 },
  ...
  { note: "Over the canal and back. A mile from the shop as the courier drives.", name: 'Gowanus', miles: 1.0 },
  ...
  { note: "Up by the promenade, about a mile and a half from the shop.", name: 'Brooklyn Heights', miles: 1.4 },
  { note: "South past the park. The whole neighborhood sits inside the band.", name: 'Prospect Lefferts Gardens', miles: 1.4 },
  { note: "North over the BQE, and closer to the shop than most of Williamsburg proper.", name: 'South Williamsburg', miles: 1.6 },
  { note: "Behind the park, a straight run down from the shop.", name: 'Windsor Terrace', miles: 1.7 },
