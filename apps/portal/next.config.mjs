...
/**
 * The policy the app carries itself.
 *
...
const securityHeaders = [
  ...
  // Nothing here uses a camera, a microphone or a location, and the payment
  // sheet lives in the iOS app. Deny them so an injected script cannot ask.
  {
