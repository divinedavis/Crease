...
final class AppLock: ObservableObject {
    ...
    // Deliberately no prompt offering the lock. It was tried after sign-in and
    // pulled the same day: a security preference nobody asked for reads as an
    // interruption between opening the app and booking a pickup, and the
    // menu toggle is where somebody who wants it goes looking anyway.
